...
const e13DeepCervicalFlexorTraining: Exercise = {
  ...
  fullContent: [
    ...
    {
      type: 'p',
      text: 'In people with chronic forward head posture and upper cervical tension, the deep cervical flexors become progressively inhibited. The superficial muscles take over their postural role, maintaining constant elevated tone to support a head position they were not designed to sustain. This is one of the primary reasons cervical tension patterns persist and rebuild — the wrong muscles are doing the postural work, and they generate abnormal upper cervical input as a consequence.',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'The common mistake at this stage is substituting superficial muscle activation for deep flexor activation — the throat muscles visibly tighten, the jaw clenches, or the chin pushes forward rather than retracting. If this is happening, reduce the effort. The deep cervical flexors are endurance muscles — they respond to low load sustained activation, not high effort contraction.',
    },
    {
      type: 'subhead',
    ...
    {
      type: 'p',
      text: 'Stage 3 does not replace Stage 1 and 2 — the lying activation work continues as the foundation.',
    },
    {
      type: 'emphasis',
  ...
  profileModifiers: [
    {
      ...
      content: [
        {
          type: 'p',
          text: 'Your assessment identified forward head posture as a confirmed finding. Deep cervical flexor inhibition is the primary muscular mechanism maintaining that posture — the deep stabilisers have progressively reduced their activity and the superficial muscles have compensated. For your pattern, this is the single most important retraining exercise in the protocol. The release work addresses the tension that has built up in the superficial muscles. This exercise addresses the underlying reason that tension keeps rebuilding. Expect Stage 1 to feel surprisingly difficult at first — significant inhibition of the deep flexors is normal and expected, and is itself confirmation that this exercise is targeting the right pattern.',
        },
      ],
    },
  ],
