...
const e14CervicalRotationHolds: Exercise = {
  ...
  fullContent: [
    ...
    {
      type: 'p',
      text: 'Sit upright in a chair with your spine neutral and your shoulders relaxed. Perform a gentle chin tuck ; this ensures the rotation occurs at the cervical spine rather than being driven by compensatory head movement.',
    },
    {
      type: 'p',
      text: 'From the chin tuck position, , moving through the full comfortable range until you reach the natural end of your rotation. Do not force beyond comfortable end range. ; maintain the retracted position throughout the movement.',
    },
    {
      type: 'p',
      text: 'At end range, hold the position isometrically for 10 seconds. ; the muscles maintaining the position against the natural tendency to drift back toward neutral. Breathe normally throughout the hold.',
    },
    {
      type: 'p',
      text: 'Return slowly to centre with control. ; the return movement should take the same time as the rotation out.',
    },
    {
      type: 'p',
  ...
  profileModifiers: [
    {
      ...
      content: [
        {
          type: 'p',
          text: 'Your assessment identified restricted rotation on your [left / right] side. Begin each set on your restricted side, working the more challenging direction first when the muscles are freshest. Perform an additional repetition on the restricted side: six repetitions to the [left / right], five to the other. ; increasing end range and reducing the effort required to hold there over time is the clearest functional sign the retraining phase is working.',
        },
      ],
    },
  ],
