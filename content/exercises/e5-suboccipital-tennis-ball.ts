  ...
  profileModifiers: [
    {
      ...
      content: [
        {
          type: 'p',
          text: 'Your assessment identified asymmetric suboccipital tenderness: more pronounced on your [left / right] side. Both sides are worked simultaneously in this exercise. Use the tenderness difference between sides ; reducing asymmetry in suboccipital tenderness over time is one of the clearest signs the release phase is working on the right side of your pattern.',
        },
      ],
    },
  ],
