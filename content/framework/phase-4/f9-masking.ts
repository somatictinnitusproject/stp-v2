...
const f9: ReadingSection = {
  ...
  content: [
    ...
    {
      type: 'p',
      text: 'The test for whether masking use has become counterproductive is simple: does the absence of the masking sound produce anxiety? If yes, the masking has become a safety behaviour rather than a tool; safety behaviours maintain the anxiety they appear to relieve.',
    },
  ],
  profileModifiers: [
    {
