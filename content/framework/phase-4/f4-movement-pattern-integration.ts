...
// daily habits is where most postural work fails"
//
// No profile modifiers per Doc 8 system note — movement pattern
// guidance applies universally regardless of driver profile.
//
...
const f4: ReadingSection = {
  kind: 'reading',
  id: 'F4_movement_pattern_integration',
  section: 'F.4',
  title: 'Movement Pattern Integration',
  estimatedMinutes: 7,
  acknowledgeLabel: 'Done',
  content: [
    {
      type: 'subhead',
      text: 'Movement Pattern Integration',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'Work through each pattern below. For each one, the goal is the same: a single specific change, applied consistently until it becomes the new default rather than a conscious correction.',
    },
    {
      type: 'subhead',
      text: 'Phone and Screen Use',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'The intervention is simple and specific: raise the phone to eye level rather than dropping the head to the phone. This feels unnatural initially because the habitual pattern is deeply ingrained. It becomes automatic within two to three weeks of consistent correction.',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'Two interventions: switch sides regularly rather than defaulting to the same shoulder every time, and where possible use a backpack to distribute the load symmetrically. Neither requires replacing existing bags — the switching habit alone meaningfully reduces the asymmetric loading pattern.',
    },
    {
      type: 'subhead',
      text: 'Walking Posture',
    },
    {
      type: 'p',
    ...
    {
      type: 'subhead',
      text: 'Carrying the Corrections Forward',
    },
    {
      type: 'p',
