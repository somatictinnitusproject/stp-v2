...
const f7: ReadingSection = {
  ...
  content: [
    ...
    {
      type: 'p',
      text: 'Choose a specific sensory input in your immediate environment and direct deliberate focused attention to it. Not passive awareness — active, detailed attention. The texture of a surface under your fingers. The specific sounds in the room other than the tinnitus. The physical sensation of your feet on the floor.',
    },
    {
      type: 'p',
