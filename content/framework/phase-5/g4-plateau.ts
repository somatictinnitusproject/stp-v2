...
const g4: Phase5ReadingSection = {
  ...
  content: [
    ...
    {
      type: 'p',
      text: 'The first thing to say clearly is that a plateau after genuine protocol engagement is not evidence that the somatic component is absent or that the work has been wasted. It is evidence that something is limiting progress that the self-directed framework cannot identify or address on its own. That is a different conclusion, and it points toward a specific next step rather than an endpoint.',
    },
    {
      type: 'subhead',
      text: 'Before Concluding You Have Plateaued',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'Before concluding that a genuine plateau has been reached, three things are worth reviewing honestly.',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'If all three are genuinely in place and progress remains absent after six to eight weeks, a plateau is the reasonable conclusion and professional input is the appropriate next step.',
    },
    {
      type: 'subhead',
      text: 'What Professional Input Looks Like at This Stage',
    },
    {
      type: 'p',
    ...
    {
      type: 'p',
      text: 'Audiological review is warranted if it has not been completed recently, or if tinnitus character has changed during the protocol period. The framework addresses somatic tinnitus specifically — a plateau may indicate that the working diagnosis needs professional reassessment rather than that the somatic work needs to continue unchanged.',
    },
    {
      type: 'p',
    ...
    {
      type: 'subhead',
      text: 'What a Plateau Is Not',
    },
    {
      type: 'p',
      text: 'A plateau is not a permanent state. Members who plateau on the self-directed protocol and pursue appropriate professional input frequently resume progress once the limiting factor is identified and addressed. The protocol work done to this point has not been wasted — the tissue changes produced by consistent release and retraining work are real and provide the foundation that professional input builds on.',
    },
    {
      type: 'p',
      text: 'A plateau is also not evidence that the tinnitus is untreatable or permanent. It is information about what this particular approach, at this particular stage, has been able to produce — and a pointer toward what the next stage of appropriate input looks like.',
    },
    {
      type: 'acknowledge_prompt',
      text: 'I’ve read the plateau framing and I’m ready to continue',
    },
  ],
}
